...
public class Bullet : MonoBehaviour
{
    ...
    [SerializeField]private Vector3 playerDefinedForward;
    [Range(0.1f, 1f)]
    ...
    [SerializeField] private bool InfiniteBounce,InfinitePierce;
    ...
    void Update()
	{
        ...
        {
            if(hit.transform.gameObject.tag == "Wall" || hit.transform.gameObject.tag == "Target")
            {
                if (bounceLeft > 0 || InfiniteBounce) DecreaseBounce = 1;
                else Despawner();
